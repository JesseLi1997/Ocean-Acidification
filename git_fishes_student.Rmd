...
## **GitHub** is not a file but a storage system. When we lose our files, we can check the history of the file's information, but it's not a file itself. Therefore, **GitHub** is not a back up for files.
